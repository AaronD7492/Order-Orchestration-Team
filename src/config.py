...
class Config:
    ...
    CIS_BASE_URL = os.getenv("CIS_BASE_URL", "http://138.197.144.135:8201")
    CIS_API_KEY = os.getenv("CIS_API_KEY", "S0MDKZEARVRd-_-ElR6viWycEosPIFNzTlaP8aTQIztJf9vT")
    ...
    AGNET_BASE_URL = os.getenv("AGNET_BASE_URL", "http://146.190.243.241:8301")
    ...
    SUPPLY_BASE_URL = os.getenv("SUPPLY_BASE_URL", "http://localhost:5002")
